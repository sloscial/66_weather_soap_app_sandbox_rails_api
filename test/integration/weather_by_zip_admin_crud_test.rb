...
class V11::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V11::WeatherByZip.new({:weather_return=>"Inflammatory tendered", :zip_code=>"Laxly nonpolitical"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V11::WeatherByZip.new({:weather_return=>"Complicates dissimilarities", :zip_code=>"Sentimentalized thoughtlessness"}, as: :"System Admin")
  ...
  test "should be able to edit instance of weather_by_zip" do
    ...
    new_value = "Capitalizing partakes"
