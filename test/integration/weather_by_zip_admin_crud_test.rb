...
class V9::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V9::WeatherByZip.new({:weather_return=>"Xmases wholeheartedly", :zip_code=>"Administrating regularity"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V9::WeatherByZip.new({:weather_return=>"Phantasmagorias temporaries", :zip_code=>"Nothings slipknot"}, as: :"System Admin")
