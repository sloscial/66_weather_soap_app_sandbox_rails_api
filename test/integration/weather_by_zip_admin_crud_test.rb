...
class V4::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V4::WeatherByZip.new({:get_city_weather_by_zip=>"Imitator nomad", :get_city_weather_by_zip_response=>"Defecting livened"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V4::WeatherByZip.new({:get_city_weather_by_zip=>"Discreetest elating", :get_city_weather_by_zip_response=>"Collaborations Incas"}, as: :"System Admin")
  ...
  test "should be able to edit instance of weather_by_zip" do
    ...
    new_value = "Pours teletypewriters"
