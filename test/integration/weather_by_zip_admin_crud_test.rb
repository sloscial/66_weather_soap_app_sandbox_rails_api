...
class V6::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V6::WeatherByZip.new({:get_city_weather_by_zip=>"Kwangju discolored", :get_city_weather_by_zip_response=>"Squeaks recruiting"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V6::WeatherByZip.new({:get_city_weather_by_zip=>"Gigglers viler", :get_city_weather_by_zip_response=>"Replenishment shaggier"}, as: :"System Admin")
  ...
  test "should be able to edit instance of weather_by_zip" do
    ...
    new_value = "Psychoanalyzes warts"
