...
class V8::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V8::WeatherByZip.new({:get_city_weather_by_zip=>"Radiologists illiteracy", :get_city_weather_by_zip_response=>"Laced eject"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V8::WeatherByZip.new({:get_city_weather_by_zip=>"Pertinacious melancholic", :get_city_weather_by_zip_response=>"Kaleidoscope Delphinus"}, as: :"System Admin")
  ...
  test "should be able to edit instance of weather_by_zip" do
    ...
    new_value = "Architecturally oddity"
