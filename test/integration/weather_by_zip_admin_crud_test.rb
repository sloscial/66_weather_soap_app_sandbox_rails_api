...
class V7::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V7::WeatherByZip.new({:get_city_weather_by_zip=>"Acculturation acidified", :get_city_weather_by_zip_response=>"Tenoned Carol"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V7::WeatherByZip.new({:get_city_weather_by_zip=>"Impeded miasmas", :get_city_weather_by_zip_response=>"Disappointingly typecasts"}, as: :"System Admin")
