...
class V5::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V5::WeatherByZip.new({:get_city_weather_by_zip=>"Maunders uncompressed", :get_city_weather_by_zip_response=>"Created Vladimir"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V5::WeatherByZip.new({:get_city_weather_by_zip=>"Productiveness courtyards", :get_city_weather_by_zip_response=>"Jezebels fusible"}, as: :"System Admin")
