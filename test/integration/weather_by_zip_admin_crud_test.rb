...
class V3::WeatherByZipAdminCRUDTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @weather_by_zip = V3::WeatherByZip.new({:get_city_weather_by_zip=>"Braves Asquith", :get_city_weather_by_zip_response=>"Cleanly highboys"}, as: :"System Admin")

    @weather_by_zip.save

    @weather_by_zip = V3::WeatherByZip.new({:get_city_weather_by_zip=>"Punctilious disarranged", :get_city_weather_by_zip_response=>"Hymnals disinclination"}, as: :"System Admin")
