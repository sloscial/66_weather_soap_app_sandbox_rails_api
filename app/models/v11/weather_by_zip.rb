class V11::WeatherByZip
  ...
  storage_names[:'1743'] = 'http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP'
  ...
  property :weather_return, Text, field: "WeatherReturn", key: false, required: false, lazy: false
  ...
  attr_accessible :weather_return, :zip_code, as: :"System Admin"
  # Default accessible scopes when nothing is defined
  attr_accessible :weather_return, :zip_code, as: :"Unauthenticated Default on create"
  attr_accessible :weather_return, :zip_code, as: :"Unauthenticated Default on update"
  attr_accessible :weather_return, :zip_code, as: :"Authenticated Without Role Default on create"
  attr_accessible :weather_return, :zip_code, as: :"Authenticated Without Role Default on update"


  def self.create(attrs = {}, as: :default)
    resource = new
    resource.assign_attributes(V11::WeatherByZip.cast_attributes(attrs), as: as )
    resource.save
    resource
  end
  ...
  def initialize(attrs = {}, options = {})
    super({})
    self.assign_attributes(V11::WeatherByZip.cast_attributes(attrs), as: options[:as] )
  end
  ...
  def self.cast_attributes(attributes = {})
    ...
    attributes.each_pair do |key,value|
      if key.is_a?(::DataMapper::Associations::Relationship)
      ...
      elsif V11::WeatherByZip.properties[key.to_sym] && value
        case V11::WeatherByZip.properties[key.to_sym].primitive.name
        when 'Integer'
        ...
        when 'BSON::ObjectId'
          ...
          new_attributes[key.to_sym] = (value.is_a?(V11::WeatherByZip.properties[key.to_sym].primitive) ? value : nil )
        end
      else
  ...
  include V11::Custom::WeatherByZip
end
