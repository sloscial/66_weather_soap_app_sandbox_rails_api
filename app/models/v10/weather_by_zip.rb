class V10::WeatherByZip
  ...
  def self.create(attrs = {}, as: :default)
    resource = new
    resource.assign_attributes(V10::WeatherByZip.cast_attributes(attrs), as: as )
    resource.save
    resource
  end
  ...
  def initialize(attrs = {}, options = {})
    super({})
    self.assign_attributes(V10::WeatherByZip.cast_attributes(attrs), as: options[:as] )
  end
  ...
  def self.cast_attributes(attributes = {})
    ...
    attributes.each_pair do |key,value|
      if key.is_a?(::DataMapper::Associations::Relationship)
      ...
      elsif V10::WeatherByZip.properties[key.to_sym] && value
        case V10::WeatherByZip.properties[key.to_sym].primitive.name
        when 'Integer'
        ...
        when 'BSON::ObjectId'
          ...
          new_attributes[key.to_sym] = (value.is_a?(V10::WeatherByZip.properties[key.to_sym].primitive) ? value : nil )
        end
      else
  ...
  include V10::Custom::WeatherByZip
end
