class Admin::GetCityWeatherByZipsController < AdminController
  ...
  def index
    ...
    @get_city_weather_by_zips = V12::GetCityWeatherByZip.all
  ...
  def show
    ...
    @get_city_weather_by_zip = V12::GetCityWeatherByZip.get((params['id'] || params[:id]).to_i)
  ...
  def create
    @get_city_weather_by_zip = V12::GetCityWeatherByZip.new(params[:get_city_weather_by_zip], as: :"System Admin")
    respond_to do |format|
