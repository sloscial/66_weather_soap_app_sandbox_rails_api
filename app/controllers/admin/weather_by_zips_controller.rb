class Admin::WeatherByZipsController < AdminController
  ...
  def index
    ...
    @weather_by_zips = V9::WeatherByZip.all
  ...
  def show
    ...
    @weather_by_zip = V9::WeatherByZip.get((params['id'] || params[:id]).to_i)
  ...
  def create
    @weather_by_zip = V9::WeatherByZip.new(params[:weather_by_zip], as: :"System Admin")
    respond_to do |format|
